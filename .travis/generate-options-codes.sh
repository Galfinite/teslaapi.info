...
export readonly MODEL_3_DESIGN_URL="https://www.tesla.com/model3/design"
export readonly MODEL3_OPTIONS_FILE="model3-options.md"
...
export readonly MODEL_Y_DESIGN_URL="https://www.tesla.com/modely/design"
export readonly MODELY_OPTIONS_FILE="modely-options.md"
...
get_options() {
  ...
  echo $'Do **not** manually edit this document. It is programmatically generated by [generate-options-codes.sh](https://github.com/galfinite/teslaapi.io/blob/master/.travis/generate-options-codes.sh).' >> ${optionsFile}
  echo $'{% endhint %}\n' >> ${optionsFile}
